# Indian Flight Fare Analysis

## Objective
As a student studying in northeast India very far from my home town, I mostly look forward to flying whenever I have to make a trip to my home or any of vacation locatons.
Whenever, I look for tickets it became a tiring job for me. I have to decide which flight to choose, how many days prior i should book tickets, should i choose direct flight or connecting flight to save my money.
To answer all these questions, I decided to do an exploratory data analysis for ticket prices to better understand the factors affecting them in India.
...
Check out the project [here](https://github.com/HemantShankar/Indian-Flight-Fare-Analysis/blob/master/Indian%20Flight%20Fare%20Analysis.ipynb)

## About the dataset

Data is gathered from the Kaggle and considered as secondary data.
The dataset includes details on the ticket booking alternatives available through the website "Easemytrip" for flights between India's top 6 metro areas. 
The cleaned dataset contains 11 characteristics and 300261 datapoints. Data was gathered in two stages: for business class tickets and for economy class tickets. The site provided a total of 300261 unique flight booking possibilities. 50 days of data were gathered, from February 11 to March 31 of 2022. 
...
Click on [Power BI Dashboard](https://github.com/HemantShankar/Indian-Flight-Fare-Analysis/blob/master/Indian%20Flight%20Fare%20Dashboard.pdf) to view the dashboard
